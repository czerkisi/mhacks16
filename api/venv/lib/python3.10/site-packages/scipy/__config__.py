...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.14.0",
                "include directory": r"../../pip-build-env-kocw4m04/overlay/lib/python3.10/site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"/private/var/folders/76/zy5ktkns50v6gt5g8r0sf6sc0000gn/T/cibw-run-gft7gyfb/cp310-macosx_arm64/build/venv/bin/python",
            "version": "3.10",
        },
    }
)
